...
seo:
  title: "Release Content Faster: How Firebase Cut Blog Publishing From Hours to
    Minutes with Astro"
  description: How Firebase, a Google-backed company, used Astro to improve their
    blog performance by 71%.
...
authors:
  - astro-team
lang: en
socialImage: /src/content/caseStudies/_images/firebase/social-image.webp
coverImage: /src/content/caseStudies/_images/firebase/cover-image.webp
headerImage: /src/content/caseStudies/_images/firebase/header.webp
---
...
import videoSrc from "./_images/firebase/firebase-blog-animation.mp4"
import firebaseFeatures from "./_images/firebase/firebase-features.webp"
import lighthouseScoreComparison from "./_images/firebase/firebase-lighthouse-before-after.webp"
import partialHydration from "./_images/firebase/partial-hydration.webp"
...
<div class="text-white space-y-8">
  <div class="text-2xl leading-normal tracking-normal text-astro-gray-100">
    ...
    ![](</src/content/caseStudies/_images/firebase/CleanShot 2026-07-25 at 18.06.00@2x.png>)
  </div>
...
<Blockquote>
  <Fragment slot="quote">
    Docs were phenomenal. What I do think was super helpful is that Astro does a very good job of\
    ...
    from underneath you. You can always develop on these assumptions.
  </Fragment>
...
<figure class="my-10">
  ...
  <figcaption class="my-4 text-center text-sm">Layered yellow slice animation.</figcaption>
</figure>
