...
description: "Introducing: Responsive partial hydration • Solid.js support • Lit
  SSR support • Named slots • Global style support • and more!"
publishDate: July 27, 2021
authors:
  - matthew
lang: en
---
import hydration from "/src/content/blog/_images/astro-018/responsive-hydration.webp"
import namedSlots from "/src/content/blog/_images/astro-018/named-slots.webp"
import litLogo from "/src/content/blog/_images/astro-018/lit-logo.svg?raw"
import solidLogo from "/src/content/blog/_images/astro-018/solid-logo-dark.svg?raw"
...
- [`<style global>`](https://docs.astro.build/guides/styling#overview) [support](https://docs.astro.build/guides/styling#overview), [GitHub syntax highlighting](https://twitter.com/n_moore/status/1417881860051509250) and a [shiny new docs site.](https://docs.astro.build/)

## Responsive partial hydration

<BlogContentImage src={hydration} alt="Code example that shows off using the new client:media hydrator." />
...
<BlogContentImage src={namedSlots} alt="Using multiple slots to provide the head and body parts of a Layout component." />
...
<p class="box" class="rounded-lg bg-astro-gray-500 p-8" set:html={solidLogo} />

<style is:inline set:text={".box { border-radius: 0.75rem; padding: 2rem 4rem; } p.box svg { box-shadow: none; }"} />
...
<p class="box" class="rounded-lg bg-astro-gray-500 p-8 text-astro-gray-100" set:html={litLogo} />
